package com.hamdi.booknetwork.history;
...
public interface BookTransactionHistoryRepository extends JpaRepository<BookTransactionHistory,Integer> {
    ...
    @Query("""
            ...
            """)
    Page<BookTransactionHistory> findAllReturnedBooks(Pageable pageable, @Param("userId") Integer id);
    @Query("""
            SELECT 
   ...
   Optional <BookTransactionHistory> findByBookIdAndUserId(@Param("bookId") Integer bookId, @Param("userId") Integer userId);
    ...
    @Query("""
            ...
            AND transaction.returnApproved = false
            """)
    Optional<BookTransactionHistory> findByBookIdAndOwnerId(Integer bookId, @Param("bookId") Integer id);
}
